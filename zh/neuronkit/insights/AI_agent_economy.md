...
解决方案在于为AI智能体量身打造的新金融基础设施。新经济需要“可编程、无许可、全球化、支持微支付、即时结算”的价值交换。区块链提供智能体可直接控制的可编程货币，使其能够自主进行API支付和智能体间交易。稳定币和闪电网络（Lightning Network）成为数字劳动力的“货币”和“无摩擦工资系统”。

该基础设施支持“按行动付费”，智能体可为每次API调用、数据点或毫秒级计算支付低至分级以下的费用。微支付——过去